...
- (void)viewDidLoad {
    ...
    congressmanRankArray = [@[@{@"name":@"王金平",@"type":@1}, @{@"name":@"柯建民",@"type":@2},@{@"name":@"洪秀柱",@"type":@1}] mutableCopy];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSDictionary *dic = congressmanRankArray[indexPath.row];
...
- (nullable NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section{
    NSString  *title ;
        ...
        title = [self.categoriesOfLaw stringByAppendingString:@"最得民心前三名"];
